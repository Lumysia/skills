...
Read `sys-software-lifecycle/SKILL.md` from the registered skills repository and follow its referenced files. This wrapper only exposes `sys-upgrade` globally for Codex hosts that scan `~/.codex/skills`.
