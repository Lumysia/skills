...
6. Capture an ordered catalog-ID snapshot before downloading.
7. For a first run, download the playlist once per codec. For later runs, compare snapshots by stable catalog ID, download additions, apply removals, then rebuild playlists.
