...
- For user-level skill wrappers managed by setup, add repository templates under `eng-agent-init/references/global-entrypoints/`; do not write directly to user global host directories unless the user explicitly asks to install them now.
